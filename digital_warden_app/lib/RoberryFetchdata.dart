...
class RobberyFetchData extends StatefulWidget{
  @override
  State<RobberyFetchData> createState() => _RobberyFetchDataState();
}

class _RobberyFetchDataState extends State<RobberyFetchData> {
