...
class CoachBus  extends StatefulWidget{
  @override
  State<CoachBus> createState() => _CoachBusState();
}

class _CoachBusState extends State<CoachBus> {
  ...
  return Scaffold(
    appBar: AppBar(
      title:   Center(child: Padding(
        ...
        child: Text("Coach/Bus Coaster",style: TextStyle(fontWeight: FontWeight.bold,),),
      )),
    ),
    body:Center(
