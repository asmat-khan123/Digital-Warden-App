...
class FlyingCoach extends StatefulWidget{
  @override
  State<FlyingCoach> createState() => _FlyingCoachState();
}

class _FlyingCoachState extends State<FlyingCoach> {
    ...
    return Scaffold(
      appBar: AppBar(
        title:   Center(child: Padding(
          ...
          child: Text("Flying Coach",style: TextStyle(fontWeight: FontWeight.bold,),),
        )),
      ),
      body:Center(
