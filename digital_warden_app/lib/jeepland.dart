...
class JeepLand extends StatefulWidget {
  @override
  State<JeepLand> createState() => _JeepLandState();
}

class _JeepLandState extends State<JeepLand> {
  ...
  return Scaffold(
    ...
    appBar: AppBar(
      title:   Center(child: Padding(
        ...
        child: Text("Jeep/Land Cruiser",style: TextStyle(fontWeight: FontWeight.bold,),),
      )),
    ),
    body:Center(
