...
class QingChi extends StatefulWidget {
  @override
  State<QingChi> createState() => _QingChiState();
}

class _QingChiState extends State<QingChi> {
 ...
 return Scaffold(
   appBar: AppBar(
     title:   Center(child: Padding(
       ...
       child: Text("Qing Chi Rickshaw",style: TextStyle(fontWeight: FontWeight.bold,),),
     )),
   ),
   body:Center(
