...
class FeetchDataPageee extends StatefulWidget {
  @override
  _FeetchDataPageeeState createState() => _FeetchDataPageeeState();
}

class _FeetchDataPageeeState extends State<FeetchDataPageee> {
      ...
      pw.Page(
        ...
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            ...
            pw.Text("PSID: ${record['baseNumber']}", style: pw.TextStyle(fontSize: 16)),
            pw.Text("Violator Name: ${record['name'] ?? 'No Name'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Phone: ${record['phone'] ?? 'No Phone'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Vehicle Number: ${record['vehiclenumber'] ?? 'No Vehicle Number'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Date and Time: ${record['dateandtime'] ?? 'No Date'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Vehicle Type: ${record['vihivlemake'] ?? 'No Vehicle Make'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Fine: ${record['amount'] ?? 'No Amount'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Document Confiscated: ${record['document_in_custody'] ?? 'No Document'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Type of Violation: ${record['valuation'] ?? 'No Valuation'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Place of Challan: ${record['place'] ?? 'No Place'}", style: pw.TextStyle(fontSize: 14)),
            pw.Text("Document Status: ${record['documentnumber'] ?? 'No Document Number'}", style: pw.TextStyle(fontSize: 14)),
          ],
        ),
      ),
    );
