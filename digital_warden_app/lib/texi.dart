...
class Texi extends StatefulWidget{
  @override
  State<Texi> createState() => _TexiState();
}

class _TexiState extends State<Texi> {
 ...
 return Scaffold(
   appBar: AppBar(
     title:   Center(child: Padding(
       ...
       child: Text("Taxi",style: TextStyle(fontWeight: FontWeight.bold,),),
     )),
   ),
   body:Center(
