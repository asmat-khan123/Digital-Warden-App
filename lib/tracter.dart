...
class Tracter extends StatefulWidget {
  @override
  State<Tracter> createState() => _TracterState();
}

class _TracterState extends State<Tracter> {
  @override
 ...
 return Scaffold(
   appBar: AppBar(
     title:   Center(child: Padding(
       ...
       child: Text("Tractor/Trolley",style: TextStyle(fontWeight: FontWeight.bold,),),
     )),
   ),
   body:Center(
