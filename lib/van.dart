...
class _VanState extends State<Van> {
  ...
  var amount;
  String? dropdownvalue;   // it will consist valuation
  String? selectedValue;   // it will use for document in custadii
   ...
   return Scaffold(
     appBar: AppBar(
       title:   Center(child: Padding(
         ...
         child: Text("Van/APV",style: TextStyle(fontWeight: FontWeight.bold,),),
       )),
     ),
     body:Center(
